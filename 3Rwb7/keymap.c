...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           DUAL_FUNC_0,                                    DUAL_FUNC_1,    KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           TD(DANCE_0),
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           MO(2),                                          KC_BSPC,        KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,
    KC_LEFT_CTRL,   KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        MAC_SIRI,
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_HYPR,                                        KC_MEH,         KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_UP,          KC_RIGHT_SHIFT,
    KC_TRANSPARENT, TG(3),          KC_TRANSPARENT, LALT(LGUI(LCTL(LSFT(KC_C)))),KC_GRAVE,                                                                                                       KC_QUOTE,       KC_SLASH,       KC_LEFT,        KC_DOWN,        KC_RIGHT,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    LALT(LCTL(KC_DELETE)),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, LGUI(KC_DOT),
                                                                                    MT(MOD_LALT, KC_SPACE),KC_LEFT_GUI,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = { {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224}, {139,233,224} },
...
void dance_0_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_MINUS)); break;
...
void dance_0_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_TAP: unregister_code16(LALT(KC_MINUS)); break;
